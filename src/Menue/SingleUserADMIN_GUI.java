...
public class SingleUserADMIN_GUI extends JFrame {
	 ...
	 * @param login 
	 */
	public SingleUserADMIN_GUI(int ID, int login, int position) {
		...
		JButton btnNewButton_1_1 = new JButton("Give Admin");
		btnNewButton_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) 
			{
				if(ID != login)
				{
					if(MySQL.ToAdmin(ID))
					{
						showMessageDialog(null, "User is Admin now");
						EditProfiles_GUI EditProfiles = new EditProfiles_GUI(login, position);
						EditProfiles.setVisible(true);
						dispose();
					}
		...
		btnNewButton_1_1.setBounds(462, 416, 130, 34);
		contentPane.add(btnNewButton_1_1);
		
		JButton btnNewButton_1_1_1 = new JButton("Lose Admin");
		btnNewButton_1_1_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) 
			{
				if(ID != login)
				{
					if(MySQL.ToCustomer(ID))
					{
						showMessageDialog(null, "User is Customer now");
						EditProfiles_GUI EditProfiles = new EditProfiles_GUI(login, position);
						EditProfiles.setVisible(true);
						dispose();
					}
		...
		btnNewButton_1_1_1.setBounds(615, 416, 130, 34);
