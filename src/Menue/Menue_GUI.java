		...
		table.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent evt) {
		        if (evt.getClickCount() == 2) {
		            ...
		            // Hier wird der showMessageDialog angezeigt
		           singleBook_GUI singleBook = new singleBook_GUI(ID,login);
		           singleBook.setVisible(true);
		           dispose();
		        }
		        else {
		            // Hier können Sie Code für Einzelklick-Ereignisse hinzufügen, falls erforderlich
		        }
		    }
		});
